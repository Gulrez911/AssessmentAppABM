				...
				<div class="column col-sm-10 col-xs-11" id="main">
					<div class="rightside">
						<div class="topmenu text-right">
							<a class="add_test" href="addtest">Add New</a> <a
								href="javascript:notify('Information', 'Feature to upload Tests coming soon. Right now we have capability to upload Users and Questions.');">Import</a>
