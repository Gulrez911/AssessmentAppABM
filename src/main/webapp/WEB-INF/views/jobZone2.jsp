																								...
																								<tr>
																										...
																										<td width="50%">
																												...
																												<div
																														...
																														<p>On the next screen, you will see careers
																																related to your Interest Profile in your chosen
																																Job Zone.</p>
																										...
																										<td width="50%">
																												...
																												<div style="width: 288px; margin: 32px auto">
																														...
																														<div
																																style="font-size: 16px; font-weight: bold; margin-top: 8px">Job
																																Zone Three</div>
																														<div style="font-size: 16px">Medium
																																Preparation Needed</div>
																												</div>
																										...
																										<td width="50%">
																												...
																												<div style="width: 288px; margin: 32px auto">
																														...
																														<div
																																style="font-size: 16px; font-weight: bold; margin-top: 8px">Job
																																Zone Five</div>
																														<div style="font-size: 16px">Extensive
																																Preparation Needed</div>
																												</div>
																						...
																						<tr>
																								<td style="height: 44px"><a
																										href="/AssesmentApp/onetHome"><img
																												...
																												src="./resources/assets/emoticons/tab1.gif"
																												alt="Start"
																								...
																								<td style="height: 44px"><a
																										href="/AssesmentApp/profiler2"><img
																												...
																												src="./resources/assets/emoticons/tab3.gif"
																												alt="Results"
																												onmouseover="hover(&#39;tab3&#39;, true)"
																												onmouseout="hover(&#39;tab3&#39;, false)"></a></td>
																								<td style="height: 44px"><a
																										href="/AssesmentApp/jobZone"><img
