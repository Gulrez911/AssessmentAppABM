				...
				<div class="container">
						...
						<div class="row">
								...
								<div class="col-md-4 col-sm-6">
										<div class="featured-item feature-icon icon-hover icon-hover-brand right-icon mt-50">
												<img src="<%=request.getContextPath()%>/resources/assets/images/Experienced.png">
										</div>
										<div class="featured-item feature-icon icon-hover icon-hover-brand right-icon mt-50">
												...
												<div class="row">
														<div class="col-md-12">
																<div class="input-field">
																		<label style="top: -20px; transform: none; font-size: 16px;">User Name</label>
														...
														<div class="col-md-12">
																<div class="input-field">
																		<label style="top: -20px; transform: none; font-size: 16px;">First Name</label>
														...
														<div class="col-md-12">
																<div class="input-field">
																		<label style="top: -20px; transform: none; font-size: 16px;">Last Name</label>
								...
								<div class="col-md-12 col-sm-12">
										...
										<div class="col-md-4 text-center">
												<div class="featured-item feature-icon icon-hover icon-hover-brand">
														<img src="<%=request.getContextPath()%>/resources/assets/images/TimeAndMoney.png">
												</div>
										</div>
										<div class="col-md-4"></div>
								</div>
