					...
					<form id="step1" method="POST" action="saveAndGoToStep2" modelattribute="test">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="input-field">
                                        ...
                                        <label for="testName">Question Type</label>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="input-field">
                                        ...
                                        <label for="qualifier2">Sub Category</label>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="input-field">
                                        ...
                                        <label for="qualifier3">Category of Sub Category</label>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="input-field">
                                        ...
                                        <label for="skls" style="top:-30px;">Skills</label>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-20">
                                    <div class="input-field">
                                        <input id="email" name="email" type="text" disabled="" value="contact@thev2technologies.com">
                                        <label for="passPercent" style="font-size: 16px;">Conducted by</label>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 mb-20">
                                    <div class="input-field">
                                        <label style="font-size: 16px;top:-40px;">Displayed upon exam completion and email communications relating to the exam</label>
                                        <input type="checkbox" id="sentToStudent1" name="sentToStudent1" value="true" />
                                        <label style="font-size: 12px;" for="sentToStudent1">Email a copy of the student's results to above contact</label>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="input-field">
                                        <label style="font-size: 16px;top:-40px;">Shuffle Questions in Test</label>
                                        <input type="checkbox" id="random" name="randomQuestions" value="true" checked="checked"/>
                                        <label for="randomQuestions"></label>
                                        <input type="hidden" name="_randomQuestions" value="on">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="input-field">
                                        ...
                                        <label for="testType" style="top:-30px;">Test Type </label>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 mb-50">
                                    <div class="input-field">
                                        <label style="font-size: 16px;top:-40px;">Proctor Settings</label>
                                        <input type="checkbox" checked="" disabled="">
                                        <label style="font-size: 12px;" for="sentToStudent1">Allow webcam proctoring </label>
                                        <input type="hidden" name="_sentToStudent" value="on">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 mt-30 mb-30">
                                    <div class="input-field">
                                        <label style="font-size: 18px;top:-65px;">Notification & Messages</label>
                                        <label style="font-size: 16px;top:-40px;">Exam Introduction Text</label>
                                        <label style="font-size: 12px;top:-10px;">Users see this text just before they begin the exam</label>
                            ...
                            <div class="row">
                                <div class="col-md-6 mt-30">
                                    <div class="input-field">
                                        <label style="font-size: 18px;top:-65px;">Text - Completion Success</label>
                                        <label style="font-size: 16px;top:-40px;">Exam Introduction Text</label>
                                        <label style="font-size: 12px;top:-10px;">Shown to the user if they pass the exam. A copy is also sent via email</label>
