	...
	<section>
		<div class = "container" style="margin-top: 10px;">
			<div class="flex" style="width:100%">
				<button class = "btn btn-primary" data-toggle="modal" data-target="#stepname_modal">+ Add Step</button>
			</div>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
    	<div class="modal-header">
      	...
      	<div class="modal-footer">
        	<button type="button" class="btn" id="btn_fin_cancel" style="background:red">Cancel</button>
      	</div>
    </div>
  </div>
</div>
