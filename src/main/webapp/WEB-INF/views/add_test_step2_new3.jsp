										...
										<div class="col-md-12">
												...
												<div class="col-md-12 text-right">
														<a href="testlist"
																...
																class="waves-effect waves-light btn cyan mt-20 mb-20" href="gobackStep1Test">Back</a>
														<a class="waves-effect waves-light btn mt-20 mb-20" href="addteststep3">Next</a>
												</div>
										</div>
								...
								<div class="modal-body">
										<div class="col-md-12 mb-20">
												...
												<a data-dismiss="modal"
														class="waves-effect waves-light btn submit-button indigo mt-20 mb-20">Cancel</a> <a
														style="color: #020014;" href="javascript:saveSection();" id="savesection"
										...
										<div class="col-md-12 mb-20">
												...
												<div class="col-md-9">
														<label style="font-size: 16px; color: #202020; font-weight: normal;" class="active">Percent
																of Qs to be asked - </label> <input type="number" onkeypress="return check(event, value)"
																oninput="checkLength()" id="txtF" placeholder="Enter percentage" style="width: 15%;"
																value="100">
												</div>
										</div>
