							...
							<c:forEach items="${test.sectionDtos}" var="section">
								<div class="quesectiondiv">
									<div class="quesection">
										${section.sectionName}- ${section.noOfQuestions}
										 
										<a href="javascript:removeSection('${section.sectionName}');"
			...
			<div class="modal-content" style="display: inline-block;">
				...
				<div class="modal-body">
					<div class="col-md-12 mb-20">
						<a href="addteststep2" class="btn waves-effect waves-light">Show
							All Parent Categories</a> <a href="javascript:showSelected();"
							id="showSelected" class="btn waves-effect waves-light green">
							Show Selected</a>
						<!--  <a
														href="http://beforesubmit.com/qe-assess/addtest_step2.html#"
														class="btn waves-effect waves-light green">Show Selected</a>  -->
						<a href="removeAllQuestions"
							class="btn waves-effect waves-light red">Clear All</a>
					...
					<div class="col-md-12 mb-20">
						...
						<div class="col-md-9">
							<label
								style="font-size: 16px; color: #202020; font-weight: normal;"
								class="active">Percent of Qs to be asked - </label> <input
								type="number" onkeypress="return check(event, value)"
								oninput="checkLength()" id="txtF" placeholder="Enter percentage"
								style="width: 15%;" value="100">
						</div>
					</div>
